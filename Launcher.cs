...
public class Launcher : MonoBehaviourPunCallbacks
{
    ...
    public void Awake()
    {
        ...
        xp = GameObject.Find("Canvas/Tabs/Main/Profile/XP").GetComponent<Text>();
        lvl= GameObject.Find("Canvas/Tabs/Main/Profile/Level").GetComponent<Text>();
        if (!string.IsNullOrEmpty(myProfile.username))
        {
            usernameField.text = myProfile.username;
            xp.text = "XP " + myProfile.xp + "/60";
            lvl.text = "LEVEL " + myProfile.level;
        }
        Connect();
    }
